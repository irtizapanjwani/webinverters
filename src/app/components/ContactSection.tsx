...
import { BRANDS, BrandLogo } from "./TrustedStrip";
...
type ContactSectionProps = {
  /** The heading's level: h1 where this section opens the page (Contact),
   *  h2 where it sits under the page's own heading (Pricing). */
  as?: "h1" | "h2";
  /** Spacing around the panel, which differs by where it sits on the page. */
  className?: string;
};

/**
 * "Start the Conversation" — the dark panel with the contact details, the
 * named contact card and the full project form. One component, so the Contact
 * page and every page that repeats the form stay identical.
 */
export default function ContactSection({ as: Heading = "h1", className = "" }: ContactSectionProps) {
  return (
      ...
      >
        ...
        <div className="relative grid items-start gap-12 lg:grid-cols-[0.95fr_1.15fr] lg:gap-14 xl:gap-20">
          ...
          <div className="flex min-w-0 flex-col">
            ...
            <Heading className="mb-6 font-display text-[clamp(24px,4.7vw,58px)] leading-[1.02] font-extrabold tracking-[-0.02em] text-white">
              Start the
              <br />
              Conversation.
            </Heading>
